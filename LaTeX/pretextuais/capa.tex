...
\primeiroassina{Nome do(a) Professor(a) Orientador(a) (Presidente de Banca) por extenso - titulação abreviada}

\segundoassina{Nome do(a) Convidado(a) por extenso - titulação abreviada}

\terceiroassina{Nome do(a) Convidado(a) por extenso - titulação abreviada}

\localdia{Teresópolis}
\mesdia{dia de mês da defesa de 2017}
